...
final class ToolbarManager: ObservableObject {
    ...
    static let defaultTools: [ToolbarTool] = [
        ...
        ToolbarTool(id: "code_search", name: "Code Search", icon: "magnifyingglass", category: "Navigation", isEnabled: true, order: 2),
        ToolbarTool(id: "errors_viewer", name: "Errors Viewer", icon: "exclamationmark.triangle.fill", category: "Diagnostics", isEnabled: true, order: 3),
        ToolbarTool(id: "dependency_manager", name: "Dependencies", icon: "shippingbox.fill", category: "Project", isEnabled: true, order: 4),
        ToolbarTool(id: "file_navigator", name: "File Navigator", icon: "folder.fill", category: "Navigation", isEnabled: true, order: 5),
        ToolbarTool(id: "build_trigger", name: "Build Shortcut", icon: "hammer.fill", category: "Build", isEnabled: false, order: 6),
        ToolbarTool(id: "command_palette", name: "Command Palette", icon: "terminal.fill", category: "Tools", isEnabled: true, order: 7),
        ToolbarTool(id: "go_to_line", name: "Go to Line", icon: "arrow.right.to.line", category: "Navigation", isEnabled: true, order: 8),
        ToolbarTool(id: "symbol_navigator", name: "Symbol Navigator", icon: "list.bullet.indent", category: "Navigation", isEnabled: true, order: 9),
        ToolbarTool(id: "github_actions", name: "GitHub Actions", icon: "arrow.triangle.2.circlepath.circle.fill", category: "Git", isEnabled: true, order: 10),
        ToolbarTool(id: "local_simulation", name: "Preview", icon: "play.display", category: "Build", isEnabled: true, order: 11),
        ToolbarTool(id: "collaboration", name: "Collaboration", icon: "person.2.badge.gearshape.fill", category: "Project", isEnabled: true, order: 12),
