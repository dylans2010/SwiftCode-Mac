        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                ...
                GroupBox {
                    VStack(alignment: .leading, spacing: 14) {
                        HStack {
                            Label("Recommended Tools (\(skill.scheme.recommendedTools.count))", systemImage: "hammer.fill")
                                .font(.headline)
                                .foregroundColor(.orange)
                            Spacer()
                        }
                ...
                GroupBox {
                    VStack(alignment: .leading, spacing: 14) {
                        HStack {
                            Label("Full Documentation", systemImage: "doc.text.fill")
                                .font(.headline)
