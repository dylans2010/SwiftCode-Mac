...
public struct GitCherryPickTool: AgentTool {
    public static let identifier = "git_cherry_pick"
    public let name = "git_cherry_pick"
    public let description = "Cherry-picks a Git commit."
    ...
    public func execute(arguments: [String: any Sendable]) async throws -> String {
        ...
        return "Successfully cherry-picked \(hash)"
    }
}
